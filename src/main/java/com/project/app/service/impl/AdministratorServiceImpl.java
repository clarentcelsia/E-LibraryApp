...
import com.project.app.entity.AdministratorDetailImpl;
import com.project.app.entity.Role;
import com.project.app.exception.ResourceNotFoundException;
import com.project.app.repository.AdministratorRepository;
...
import com.project.app.specification.AdministratorSpecification;
...
public class AdministratorServiceImpl implements AdministratorService {
    ...
    public Administrator getActiveAdministrator(String id) {
        return administratorRepository.getActiveAdministrator(id).orElseThrow(() -> new ResourceNotFoundException("Administrator not found"));
    }
