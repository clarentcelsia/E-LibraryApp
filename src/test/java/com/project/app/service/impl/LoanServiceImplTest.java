...
class LoanServiceImplTest {
    ...
    public void getAll_ShouldReturn_AllPagedLoans(){
        ...
        // actual
        Mockito.when(repository.findAll(any(Specification.class), any(Pageable.class))).thenReturn(loanPage);
    ...
    public void createTransaction_ShouldReturn_LoanTransaction(){
        ...
        // mock repo , actual
        Mockito.when(bookService.getBookById(any(String.class))).thenReturn(book);
        Mockito.when(repository.save(any(Loan.class))).thenReturn(outputLoan);
        Mockito.when(loanDetailService.create(any(LoanDetail.class))).thenReturn(loanDetailOne);
